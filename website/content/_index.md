    ...
    <div class="hero__terminal">
      <div class="terminal">
        ...
        <div class="terminal__body">
          <span class="terminal__comment"># Fully local. No API keys.</span><br>
          <span class="terminal__prompt">$</span> curl -fsSL <span class="terminal__url">https://magec.dev/install</span> | bash<br><br>
          <span class="terminal__comment"># Or pick your cloud provider</span><br>
          ...
          <span class="terminal__comment"># Admin UI → <span class="terminal__url">localhost:8081</span></span><br>
          <span class="terminal__comment"># Voice UI → <span class="terminal__url">localhost:8080</span></span>
        </div>
      </div>
    </div>
  </div>
...
<section id="quickstart">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h2 class="section-title">One command to go</h2>
    </div>
    <div class="quickstart-oneliner reveal">
      <p class="quickstart-oneliner__desc">Fully local. No API keys, no sign-ups.</p>
      <pre><code><span class="terminal__prompt">$</span> curl -fsSL https://raw.githubusercontent.com/achetronic/magec/main/scripts/install.sh | bash</code></pre>
      <p class="quickstart-oneliner__flags"><code>--openai</code> · <code>--anthropic</code> · <code>--gemini</code> to use cloud APIs · <code>--gpu</code> for NVIDIA · <code>--help</code> for all options</p>
    </div>
    <p class="quickstart-separator reveal">or manually</p>
...
<span class="terminal__prompt">$</span> cd magec/docker/compose
<span class="terminal__prompt">$</span> cp docker-compose.local.yaml docker-compose.override.yaml
<span class="terminal__prompt">$</span> docker compose up -d</code></pre>
      ...
      <div class="quickstart-card">
        ...
        <p class="quickstart-card__desc">Pick your provider: <code>openai</code>, <code>anthropic</code>, or <code>gemini</code>.</p>
        <pre><code><span class="terminal__prompt">$</span> git clone https://github.com/achetronic/magec.git
<span class="terminal__prompt">$</span> cd magec/docker/compose
<span class="terminal__prompt">$</span> cp docker-compose.anthropic.yaml docker-compose.override.yaml
<span class="terminal__prompt">$</span> export ANTHROPIC_API_KEY=sk-ant-...
<span class="terminal__prompt">$</span> docker compose up -d</code></pre>
