    ...
    "paths": {
        ...
        "/flows": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Flow definition (nodes + edges graph)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/runs/{id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Include raw events payload",
                        "name": "raw",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "store.FlowDefinition": {
            ...
            "properties": {
                ...
                "edges": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/store.FlowEdge"
                    }
                },
                "entry": {
                    "type": "string"
        ...
        "store.FlowNode": {
            ...
            "properties": {
                ...
                "flowId": {
                    "description": "FlowID references another FlowDefinition embedded as a nested workflow.\nRequired when Type is FlowNodeSubflow, ignored otherwise.",
                    "type": "string"
                },
                "h": {
                    "type": "number"
        ...
        "store.FlowsSettings": {
            ...
            "properties": {
                ...
                "executionTimeoutMs": {
                    "description": "ExecutionTimeoutMs is the global ceiling for a code node's wall-clock\nexecution time in milliseconds. 0 means no limit.",
                    "type": "integer"
                },
                "maxOutputBytes": {
                    "description": "MaxOutputBytes is the global ceiling for a code node's JSON-serialised\noutput size in bytes. 0 means no limit.",
                    "type": "integer"
                }
            }
        },
        ...
        "store.Settings": {
            ...
            "properties": {
                "flows": {
                    "description": "Flows holds global settings for the Starlark code-node feature.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/store.FlowsSettings"
                        }
                    ]
                },
                "longTermProvider": {
